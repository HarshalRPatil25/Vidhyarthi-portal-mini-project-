...
if (isset($_POST['Submit'])) {
  ...
  if (empty($pname1 || $pname2 || $pname3 || $pname4 || $pname5 || $pname6 ||
   ...
   $pname13 || $pname14 || $pname15 || $pname16 || $pname17||$pname18 || $pname19 || $pname20)) {
    ...
    $condition = false;
    if(!$condition){
      mysqli_query($con, "update $subject set ca2='$pname1' where Roll_No=1");
      mysqli_query($con, "update $subject set ca2='$pname2' where Roll_No=2");
      mysqli_query($con, "update $subject set ca2='$pname3' where Roll_No=3");
      mysqli_query($con, "update $subject set ca2='$pname4' where Roll_No=4");
      mysqli_query($con, "update $subject set ca2='$pname5' where Roll_No=5");
      mysqli_query($con, "update $subject set ca2='$pname6' where Roll_No=6");
      mysqli_query($con, "update $subject set ca2='$pname7' where Roll_No=7");
      mysqli_query($con, "update $subject set ca2='$pname8' where Roll_No=8");
      mysqli_query($con, "update $subject set ca2='$pname9' where Roll_No=9");
      mysqli_query($con, "update $subject set ca2='$pname10' where Roll_No=10");
      mysqli_query($con, "update $subject set ca2='$pname11' where Roll_No=11");
      mysqli_query($con, "update $subject set ca2='$pname12' where Roll_No=12");
      mysqli_query($con, "update $subject set ca2='$pname13' where Roll_No=13");
      mysqli_query($con, "update $subject set ca2='$pname14' where Roll_No=14");
      mysqli_query($con, "update $subject set ca2='$pname15' where Roll_No=15");
      mysqli_query($con, "update $subject set ca2='$pname16' where Roll_No=16");
      mysqli_query($con, "update $subject set ca2='$pname17' where Roll_No=17");
      mysqli_query($con, "update $subject set ca2='$pname18' where Roll_No=18");
      mysqli_query($con, "update $subject set ca2='$pname19' where Roll_No=19");
      mysqli_query($con, "update $subject set ca2='$pname20' where Roll_No=20");
      $condition = true;
    }
